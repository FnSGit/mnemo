...
- **Weibull decay engine** — Stretched-exponential forgetting with tier-based lifecycle (Core beta=0.8, Working beta=1.0, Peripheral beta=1.3)
...
- **License key system** — Device-bound activation with hardware fingerprinting
